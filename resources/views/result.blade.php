...
@section('content')
    ...
    <div class="max-w-6xl mx-auto my-8 p-1 lg:p-6 shadow-xl rounded-lg border border-gray-200 print:p-0 print:border-none"
        ...
        <div class="mb-6 print:hidden" style="opacity: 1; transform: none;">
            ...
            <input id="studentId" placeholder="e.g., 750279"
        ...
        <div class="container mt-6 print:m-0" style="opacity: 1; transform: none;">
            <header
                ...
                <div class="flex-shrink-0 flex items-center">
                    <div class="flex justify-center items-start pt-2 md:pt-8">
                        <img alt="Student"
                            ...
                            src="https://i.ibb.co/35q6tW8W/IMG-20250920-WA0020.jpg" />
                    </div>
                </div>
            </header>
            ...
            <table class="w-full border border-gray-200 overflow-hidden mb-6">
                <tbody>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200 text-left">Name of Student
                        </td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">Nasir Uddin</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Father's Name</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">Nazmul Haldere</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Mother's Name</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">Shahin Akter</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Date of Birth</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">1998-04-17</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Institute Name</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">Technical Training Centre</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Roll</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">950028</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Registration No</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">57000028</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Student Type</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">Regular</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Course Duration</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">4 years</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Session</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">2018-2021</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">Course Name</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">Diploma in Textile Engineering</td>
                    </tr>
                    <tr class="odd:bg-gray-50">
                        <td class="px-4 py-2 font-medium text-gray-700 border border-gray-200">CGPA Result</td>
                        <td class="px-4 py-2 text-gray-900 border border-gray-200">3.70</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="w-full border border-gray-200 overflow-hidden">
                <thead class="bg-gray-100">
                    ...
                    <tr>
                        <th class="px-4 py-2 text-left text-gray-700 font-semibold border border-gray-200">Semester</th>
                        <th class="px-4 py-2 text-left text-gray-700 font-semibold border border-gray-200">Grade</th>
                        <th class="px-4 py-2 text-left text-gray-700 font-semibold border border-gray-200">Grade Point</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <table class="min-w-full border border-gray-300 mt-6 overflow-hidden shadow-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr class="odd:bg-white even:bg-gray-50">
                        <td class="w-1/7 text-center text-gray-900 border border-gray-300 px-2 py-2 text-xs sm:text-base">
                            3200</td>
                        <td class="w-1/7 text-center text-gray-900 border border-gray-300 px-2 py-2 text-xs sm:text-base">
                            260</td>
                        <td class="w-1/7 text-center text-gray-900 border border-gray-300 px-2 py-2 text-xs sm:text-base">
                        ...
                        <td class="w-1/7 text-center text-gray-900 border border-gray-300 px-2 py-2 text-xs sm:text-base">
                            3.75</td>
                        <td class="w-1/7 text-center text-gray-900 border border-gray-300 px-2 py-2 text-xs sm:text-base">A
                        </td>
                    </tr>
                </tbody>
            </table>
