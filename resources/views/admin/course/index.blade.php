    ...
    <div class="w-full mb-4">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center pb-4 border-b rounded-md mb-4">
            <div class="flex flex-col gap-2 w-full md:w-2/3">
                ...
                <p class="text-sm text-gray-500 ml-1">Manage your course and their transactions efficiently</p>
            </div>
            <div class="flex flex-row gap-2 mt-3 md:mt-0 w-full md:w-auto items-start sm:items-center">
                <a href="{{ route('admin.courses.create') }}"
                    ...
                    <i class="ri-add-line text-lg"></i> Course Create
                </a>
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-100 transition-colors cursor-pointer">
                            ...
                            <td class="px-4 py-3 text-right whitespace-nowrap">
                                <div class="flex justify-end items-center gap-1">
                                    <a href="{{ route('admin.courses.edit', $data->id) }}"
                                    ...
                                    <form action="{{ route('admin.courses.status', $data->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit"
                                    ...
                                    <form action="{{ route('admin.courses.delete', $data->id) }}" method="POST"
